...
public static class DelaunayTest
{
    ...
    public static void DoSegmentMerge()
    {
        ...
        SegmentMerge sm = new SegmentMerge();

        sm.Add( new SegmentMerge.Segment( 0f, 3f ) );
        sm.Add( new SegmentMerge.Segment( 1f, 2f ) );
        sm.Add( new SegmentMerge.Segment( 1f, 4f ) );
        sm.Add( new SegmentMerge.Segment( 5f, 7f ) );
        //sm.Add( new SegmentMerge.Segment( 1f, 5f ) );
        // sm.Add( new SegmentMerge.Segment( 0f, 0.1f ) );
